# Generated by Django 5.2.1 on 2025-05-17 06:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('complaint_type', models.CharField(choices=[('hostel', 'Hostel'), ('mess', 'Mess'), ('faculty', 'Faculty'), ('library', 'Library')], max_length=20)),
                ...
                ('library_issue_type', models.CharField(blank=True, choices=[('wifi', 'WiFi Issue'), ('book_not_found', 'Book Not Found'), ('other', 'Other')], max_length=20, null=True)),
